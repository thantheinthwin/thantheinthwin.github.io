    ...
    >
      ...
      >
        <div ref={myRef} className='w-full'>
          { isInView &&
            <motion.div variants={container} initial='hidden' animate='show' exit='exit' className='grid items-center justify-center w-full grid-cols-1 gap-2 text-center'>
              <motion.div variants={title}><Typography variant='h4' sx={{fontWeight: 'bold'}}>Qualification</Typography></motion.div>
              <motion.div variants={title}><Typography variant='body2' sx={{color: 'grey.700'}}>My personal journey</Typography></motion.div>
              <motion.div variants={content} className='grid justify-center w-full grid-cols-1 gap-1'>
